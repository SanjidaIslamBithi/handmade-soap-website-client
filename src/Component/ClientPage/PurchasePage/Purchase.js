...
const Purchase = () => {
  ...
  const handleBookingSubmit = (e) => {
    ...
    fetch('https://salty-hamlet-93150.herokuapp.com/allbuyingproducts', {
      method: 'POST',
      headers: {
...
// formData.append(...buyingInfo);
// formData.append('productname', topproducts.name);
// formData.append('productprice', topproducts.price);
// console.log(formData);

// useEffect(() => {
//   fetch(`https://salty-hamlet-93150.herokuapp.com/topproducts/${productId}`)
//     .then((res) => res.json())
